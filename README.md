...
|---|---|---|
| `/add текст` | `/add python` | личная подборка (поиск везде, вся Россия) |
| `/list` | | мои подборки с номерами |
| `/del номер` | `/del 1` | удалить свою подборку |
| `/rating 0–5` | `/rating 4.5` | мин. рейтинг работодателя для моих подборок |
| `/schedule вид` | `/schedule удалённо` | график: remote/удалённо, fullday, flexible, shift, vahta, any |
| `/area регион` | `/area москва` | москва (1), питер (2), россия (113) |
