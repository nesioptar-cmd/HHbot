...
- **🔍 Новая подборка** → спрашивает ключевые слова → **источник
  (hh.ru — вакансии / FL.ru — заказы)** → меню кнопками:
  где искать, регион, график, занятость, опыт,
  зарплата (пороги + своя сумма), рейтинг → **✅ Подписаться**.
  Для FL.ru актуальны только слова и место поиска.
...
netlify/lib/fl.mjs                  FL.ru: RSS-лента заказов + matching
...
test/fl.mjs                         стенд источника FL.ru
